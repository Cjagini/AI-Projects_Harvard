...
knowledge1 = And(
    ...
    # A is a knight if and only if "Both A and B are knaves" is true
...
knowledge2 = And(
    ...
    # A is a knight if and only if (both are knights OR both are knaves)
    Biconditional(AKnight, Or(And(AKnight, BKnight), And(AKnave, BKnave))),

    # B is a knight if and only if (one is knight and one is knave)
...
knowledge3 = And(
    ...
    # B says "A said 'I am a knave'"
    # If B is a knight, then what B said is true: (A is a knight <=> A said "I am a knave")
